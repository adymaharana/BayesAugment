        ...
        while True:
            ...
            for b in beams:
                ...
                for z in range(beam_size):
                    ...
                    beam_candidates.append((curr_prob + final_preds[word_idx].item(),
                        hn, cn, seq + [word_idx]))
        ...
        while True:
            ...
            for b_idx in beam_dict:
                ...
                if num_examples == len(beam_dict):
                    ...
                    for z in range(beam_size):
                        word_idx = top_indices[z].item()
                        beam_candidates.append((preds[word_idx].item(),
                    ...
                    for o_idx, ob in enumerate(origin_beams):
                        ...
                        for z in range(beam_size):
                            ...
                            beam_candidates.append((curr_prob + float(preds[word_idx].cpu().item()),
...
if __name__ == '__main__':
    ...
    vocab, rev_vocab = \
        pickle.load(open(args.vocab, 'rb'))
