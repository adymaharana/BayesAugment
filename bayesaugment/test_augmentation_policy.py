...
base_args = Namespace(**{'local_rank': -1,
                         'train_file': '../AutoAdverse/data/train-sampled-v1.1.json',
                         'predict_file': '../OpenNMT/mlqa-de-en-dev.json',
                         'output_dir': './out/germanqa-bayes-best/',
                         'doc_stride': 128,
...
def roberta_train_and_eval(arg_string, adversarial_policy):
    ...
    #if results['f1'] > global_max_f1:
    #    global_max_f1 = results['f1']
...
def test_roberta():
    result = augmentation_wrapper(AddSentDiverse=0.297, 
                              AddKSentDiverse=0.598, 
                              AddAnswerPosition=0.002, 
                              PerturbAnswer=0.0226,
                              AddSentDiverse_PerturbAnswer=0.058,
                              AddKSentDiverse_PerturbAnswer=0.1066,
                              AddAnswerPosition_PerturbAnswer=0.0419,
                              PerturbQuestion=0.855,
                              AddSentDiverse_PerturbQuestion=0.6213,
                              AddAnswerPosition_PerturbQuestion=0.1417)
...
def optimize_roberta():
 ...
 #                "InvalidateAnswer": (0, 1.0),
                 ...
                 "PerturbQuestion": (0, 1),
                 "AddSentDiverse_PerturbQuestion": (0,1),
                 "AddAnswerPosition_PerturbQuestion": (0,1)},
        random_state=1234,
        verbose=2
    )
    optimizer.maximize(
